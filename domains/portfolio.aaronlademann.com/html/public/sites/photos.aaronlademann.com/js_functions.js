...
function fixBrokenImages(container,type){
	...
	comingSoonImg = "http://portfolio.aaronlademann.com/public/images/photos_thumbnail-coming-soon_100x100.png";
	...
	if(type = "error"){
		...
		$.each(theseImages, function(){
			...
			$(this).bind('error', function(){
					$(this).attr("src", "http://portfolio.aaronlademann.com/public/images/photos_thumbnail-coming-soon_100x100.png");
					$(this).addClass("error");
			});
