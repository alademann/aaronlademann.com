...
$meta_box = array(
	...
	array(
		...
		array(
			'name' =>  __('Image 11', 'framework'),
			'desc' => __('550px x unlimited', 'framework'),
			'id' => $prefix.'portfolio_image11',
			'type' => 'text',
			'std' => ''
		),
		array(
			'name' => '',
			'desc' => '',
			'id' => $prefix.'portfolio_image_button11',
			'type' => 'button',
			'std' => 'Browse'
		),
		array(
			'name' =>  __('Image 12', 'framework'),
			'desc' => __('550px x unlimited', 'framework'),
			'id' => $prefix.'portfolio_image12',
			'type' => 'text',
			'std' => ''
		),
		array(
			'name' => '',
			'desc' => '',
			'id' => $prefix.'portfolio_image_button12',
			'type' => 'button',
			'std' => 'Browse'
		),
		array(
			'name' =>  __('Image 13', 'framework'),
			'desc' => __('550px x unlimited', 'framework'),
			'id' => $prefix.'portfolio_image13',
			'type' => 'text',
			'std' => ''
		),
		array(
			'name' => '',
			'desc' => '',
			'id' => $prefix.'portfolio_image_button13',
			'type' => 'button',
			'std' => 'Browse'
		),
		array(
			'name' =>  __('Image 14', 'framework'),
			'desc' => __('550px x unlimited', 'framework'),
			'id' => $prefix.'portfolio_image14',
			'type' => 'text',
			'std' => ''
		),
		array(
			'name' => '',
			'desc' => '',
			'id' => $prefix.'portfolio_image_button14',
			'type' => 'button',
			'std' => 'Browse'
		),
		array(
			'name' =>  __('Image 15', 'framework'),
			'desc' => __('550px x unlimited', 'framework'),
			'id' => $prefix.'portfolio_image15',
			'type' => 'text',
			'std' => ''
		),
		array(
			'name' => '',
			'desc' => '',
			'id' => $prefix.'portfolio_image_button15',
			'type' => 'button',
			'std' => 'Browse'
		),
	...
	foreach ($meta_box['fields'] as $field) {
		...
		switch ($field['type']) {
			...
			echo '<tr style="border-top:1px solid #eeeeee;">',
				...
				'<td>';
			echo '<input type="text" name="', $field['id'], '" id="', $field['id'], '" value="', $meta ? $meta : stripslashes(htmlspecialchars(( $field['std']), ENT_QUOTES)), '" size="30" style="width:75%; margin-right: 20px; float:left; direction: rtl;" />';
