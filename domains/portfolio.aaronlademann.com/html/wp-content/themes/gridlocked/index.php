...
<section id="primary" class="hfeed span12">
	...
	<article style="padding-left: 24px;" class="emptyResults">
		...
		<p>Sorry, there are no projects matching the query "<?php echo $searchQ; ?>". <br /><br />Eventually, Aaron should be adding projects here - but in the meantime, you can <a rel="nofollow" href="mailto:aaron.lademann@gmail.com?subject=Empty Search Page for  <?php echo $searchQ; ?>">Contact Aaron</a> to let him know you were looking for  <?php echo $searchQ; ?> Projects.</p>
	</article>
